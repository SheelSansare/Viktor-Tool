...
def get_color(value: int) -> Color:
    ...
    See "app/tests/test_get_color.py" for an example test written for this method.
    """
...
class Parametrization(ViktorParametrization):
    ...
    report.upload.text = Text(
        ...
        "directly to the app.\\\n"
        "\\\n"
        "**Challenge**: copy \"app/my_entity_type/report_template.docx\" from the demo app's source code, modify it to "
        "your liking, and upload it using this file-field, to generate and download a report that differs from the "
        "default one."
    )
